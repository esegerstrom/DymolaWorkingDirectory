...
protected
  ...
  parameter OpenIPSL.Types.PerUnit ud0=v_0*cos(
      angle_0 - delta0 + Modelica.Constants.pi/2)
    "d-axis component of initial voltage";
  parameter OpenIPSL.Types.PerUnit uq0=v_0*sin(
      angle_0 - delta0 + Modelica.Constants.pi/2)
  ...
  parameter OpenIPSL.Types.PerUnit Epq0=uq0 + Xpd
      *id0 + R_a*iq0;
  parameter Real dsat=SE(
      ...
      1,
      1.2);
  parameter OpenIPSL.Types.PerUnit efd0=Epq0*(1
       + dsat) + (Xd - Xpd)*id0 "Initial field voltage magnitude";
