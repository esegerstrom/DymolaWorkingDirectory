...
model SHAF25_SMIB
  ...
  SHAF25.Components.GenerationUnits.GenUnit_withInterface genUnit_withInterface
...
equation
  ...
  connect(pwLine2.n, GEN2.p) annotation (Line(points={{65.4,30},{70,30},{70,0},{80,0}},
                   color={0,0,255}));
  connect(genUnit_withInterface.pwPin, GEN1.p)
    annotation (Line(points={{-59.0909,0},{-30,0}}, color={0,0,255}));
end SHAF25_SMIB;
