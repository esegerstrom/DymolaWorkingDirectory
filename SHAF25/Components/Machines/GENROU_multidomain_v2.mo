within SHAF25.Components.Machines;
model GENROU_multidomain_v2
  ...
  extends
    SHAF25.BaseModels.Machines.baseMachineMultidomain_v2(
    XADIFD(start=efd0),
    ...
    Te(start=pm0));
  //Machine parameters
  parameter OpenIPSL.Types.PerUnit Xpq
    "q-axis transient reactance "
    annotation (Dialog(group="Machine parameters"));
  parameter OpenIPSL.Types.Time Tpq0
    "q-axis transient open-circuit time constant"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenIPSL.Types.PerUnit Xpp=Xppd
    "Sub-transient reactance " annotation (Dialog(group="Machine parameters"));
  OpenIPSL.Types.PerUnit Epd(start=
        Epd0) "d-axis voltage behind transient reactance ";
  OpenIPSL.Types.PerUnit Epq(start=
        Epq0) "q-axis voltage behind transient reactance ";
  OpenIPSL.Types.PerUnit PSIkd(start=
        PSIkd0) "d-axis rotor flux linkage ";
  OpenIPSL.Types.PerUnit PSIkq(start=
        PSIkq0) "q-axis rotor flux linkage ";
  //State variables
  OpenIPSL.Types.PerUnit PSId(start=
        PSId0) "d-axis flux linkage ";
  OpenIPSL.Types.PerUnit PSIq(start=
        PSIq0) "q-axis flux linkage ";
  OpenIPSL.Types.PerUnit PSIppd(start=
        PSIppd0) "d-axis subtransient flux linkage ";
  OpenIPSL.Types.PerUnit PSIppq(start=
        PSIppq0) "q-axis subtransient flux linkage ";
  OpenIPSL.Types.PerUnit PSIpp
    "Air-gap flux ";
  OpenIPSL.Types.PerUnit XadIfd(start=
        efd0) "d-axis machine field current ";
  OpenIPSL.Types.PerUnit XaqIlq(start=0)
...
protected
  ...
  parameter OpenIPSL.Types.Angle ang_PSIpp0=arg(
      PSIpp0) "flux angle";
  parameter OpenIPSL.Types.Angle ang_It=arg(It)
    "current angle";
  parameter OpenIPSL.Types.Angle ang_PSIpp0andIt=
      ang_PSIpp0 - ang_It "angle difference";
  parameter OpenIPSL.Types.PerUnit abs_PSIpp0='abs'(
      PSIpp0) "magnitude of sub-transient flux linkage";
  ...
  parameter OpenIPSL.Types.Angle delta0=atan(b*
      cos(ang_PSIpp0andIt)/(b*sin(ang_PSIpp0andIt) - a)) + ang_PSIpp0
  ...
  parameter OpenIPSL.Types.PerUnit PSIppq0=imag(
      PSIpp0_dq) "q-axis component of the sub-transient flux linkage";
  parameter OpenIPSL.Types.PerUnit PSIppd0=real(
      PSIpp0_dq) "d-axis component of the sub-transient flux linkage";
  //Initialization of current and voltage components in rotor reference frame (dq-axes).
  parameter OpenIPSL.Types.PerUnit iq0=real(I_dq)
    "q-axis component of initial current";
  parameter OpenIPSL.Types.PerUnit id0=imag(I_dq)
    "d-axis component of initial current";
  parameter OpenIPSL.Types.PerUnit ud0=(-(
      PSIppq0 - Xppq*iq0)) - R_a*id0 "d-axis component of initial voltage";
  parameter OpenIPSL.Types.PerUnit uq0=PSIppd0
       - Xppd*id0 - R_a*iq0 "q-axis component of initial voltage";
  ...
  parameter OpenIPSL.Types.PerUnit pm0=p0 + R_a*
      iq0*iq0 + R_a*id0*id0 "Initial mechanical power (machine base)";
  parameter OpenIPSL.Types.PerUnit efd0=dsat*
      PSIppd0 + PSIppd0 + (Xpd - Xpp)*id0 + (Xd - Xpd)*id0
    "Initial field voltage magnitude";
  parameter OpenIPSL.Types.PerUnit Epq0=PSIkd0 +
      (Xpd - Xl)*id0;
  parameter OpenIPSL.Types.PerUnit Epd0=PSIkq0 -
      (Xpq - Xl)*iq0;
  //Initialize remaining states:
  parameter OpenIPSL.Types.PerUnit PSIkd0=(PSIppd0
       - (Xpd - Xl)*K3d*id0)/(K3d + K4d) "d-axis initial rotor flux linkage";
  parameter OpenIPSL.Types.PerUnit PSIkq0=((-
      PSIppq0) + (Xpq - Xl)*K3q*iq0)/(K3q + K4q)
    "q-axis initial rotor flux linkage";
  parameter OpenIPSL.Types.PerUnit PSId0=PSIppd0
       - Xppd*id0;
  parameter OpenIPSL.Types.PerUnit PSIq0=(-PSIppq0)
       - Xppq*iq0;
  // Constants
